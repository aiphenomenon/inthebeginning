 ...
 *
 * All values are in simulation units (SU) scaled for computational
 * tractability.  Real-world proportions are maintained where possible.
 *
 * Faithfully ported from simulator/constants.py
 */
#ifndef ITB_CONSTANTS_H
#define ITB_CONSTANTS_H
...
#define NUM_ELECTRON_SHELLS     7
static const int ELECTRON_SHELLS[NUM_ELECTRON_SHELLS] = {2, 8, 18, 32, 32, 18, 8};
#define BOND_ENERGY_COVALENT        3.5
#define BOND_ENERGY_IONIC           5.0
#define BOND_ENERGY_HYDROGEN_BOND   0.2
#define BOND_ENERGY_VAN_DER_WAALS   0.01

/* === Biology parameters === */
#define NUM_NUCLEOTIDE_BASES    4
static const char NUCLEOTIDE_BASES[4] = {'A', 'T', 'G', 'C'};
static const char RNA_BASES[4]        = {'A', 'U', 'G', 'C'};

#define NUM_AMINO_ACIDS 20
static const char *AMINO_ACIDS[NUM_AMINO_ACIDS] = {
...
/* === Screensaver-specific limits === */
#define MAX_PARTICLES       512
#define MAX_ATOMS           256
#define MAX_MOLECULES       128
#define MAX_CELLS           100
#define MAX_GENES           8
#define MAX_PROTEINS        32
#define MAX_BONDS           4
#define MAX_EPIGENETIC      16
#define MAX_DNA_LENGTH      120
#define MAX_PROTEIN_LENGTH  64
#define MAX_EVENTS          16

#endif /* ITB_CONSTANTS_H */
