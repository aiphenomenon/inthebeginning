...
APPS = [
    ...
    },
    {
        ...
        "build": ["mkdir -p build/classes",
                  "javac -d build/classes -sourcepath src/main/java src/main/java/com/inthebeginning/simulator/*.java"],
        "run": ["java", "-Djava.awt.headless=true", "-cp", "build/classes", "com.inthebeginning.simulator.SimulatorApp"],
        "cwd": "apps/java",
        "timeout": 60,
    },
    {
